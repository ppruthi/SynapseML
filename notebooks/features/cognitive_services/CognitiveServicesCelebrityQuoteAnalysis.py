...
bingSearch = BingImageSearch()  .setSubscriptionKey(BING_IMAGE_SEARCH_KEY)  .setOffsetCol("offset")  .setQuery("celebrity quotes")  .setCount(imgsPerBatch)  .setOutputCol("images")
...
celebs = RecognizeDomainSpecificContent()          .setSubscriptionKey(VISION_API_KEY)          .setModel("celebrities")          .setUrl("https://eastus.api.cognitive.microsoft.com/vision/v2.0/")          .setImageUrlCol("url")          .setOutputCol("celebs")
...
recognizeText = RecognizeText()  .setSubscriptionKey(VISION_API_KEY)  .setUrl("https://eastus.api.cognitive.microsoft.com/vision/v2.0/recognizeText")  .setImageUrlCol("url")  .setMode("Printed")  .setOutputCol("ocr")  .setConcurrency(5)
...
sentimentTransformer = TextSentiment()    .setTextCol("text")    .setUrl("https://eastus.api.cognitive.microsoft.com/text/analytics/v3.0/sentiment")    .setSubscriptionKey(TEXT_API_KEY)    .setOutputCol("sentiment")
