...
get_ipython().system('pip install --upgrade raiwidgets')
get_ipython().system('pip install itsdangerous==2.0.1')


# In[ ]:


get_ipython().system('pip install --upgrade interpret-community')
